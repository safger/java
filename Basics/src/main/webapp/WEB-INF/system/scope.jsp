		...
		$(function(){
			...
			$('#OrganizeTree').treegrid({
				...
				onClickRow:function(row){
					$("#userFr").attr("src","<%=basePath %>system/scope/showScope.html?OrganizeId="+row.fuid+"&date="+new Date());
				} 
			});
		});
...
<body class="easyui-layout">
	...
	<div data-options="region:'center',title:'数据集权限管理'"  >
			 <iframe  scrolling="no"    frameborder="0" id="userFr" width="100%" height="2000px"  src=""></iframe>
	</div>
</body>
</html>
</html>
