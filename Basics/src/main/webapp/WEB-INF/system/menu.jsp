		...
		<div>
			<div class="manage-title">
				<div class="manage-title-l"
					...
					<span class="hui-14-41-b">菜单管理</span>
				</div>
				...
				<table width="100%" cellSpacing="0" cellPadding="0" class="table">
       			 <tr class="title">
       				 ...
       				 <c:forEach items="${parentList }" var="list" varStatus="stuts" >
						  ...
						  <td><strong> ${list.menuName } </strong>&nbsp;</td>
						  <td>${list.menuUrl }&nbsp;</td>
						  <td>${list.menuOrder }&nbsp;</td>
						  <td   align="center" >
							<a class="blue-12"  href="<%=basePath%>system/menu/menu_edit.html?parentid=${list.fuid }">新增子目录</a>
							<a class="blue-12"  href="<%=basePath %>system/menu/updateShow.html?id=${list.fuid }">修改</a>
						 ...
						 <c:if test="${list.children != null}">
						 	 <c:forEach items="${list.children }" var="clist" varStatus="stuts" >
								  ...
								  <c:if test="${obj.count%2 != '0'}">
									  ...
									  <td style="color: blue;">----${ clist.menuName} &nbsp;</td>
									  <td>${ clist.menuUrl}&nbsp; </td>
										<td  >${ clist.menuOrder}&nbsp;</td>
										<td   align="center" >
											<a class="blue-12"  href="<%=basePath%>system/menu/menu_edit.html?parentid=${clist.fuid }">新增子目录</a>
											<a class="blue-12"  href="<%=basePath %>system/menu/updateShow.html?id=${clist.fuid }">修改</a>
									...
									<c:if test="${clist.children!=null }">
										 <c:forEach items="${clist.children }" var="cclist" varStatus="stuts" >
										 	<c:if test="${stuts.count%2 == '0'}">
											  ...
											  <td style="color: red;">---------${cclist.menuName}&nbsp;</td>
												<td>${cclist.menuUrl}&nbsp;</td>
												<td  >${cclist.menuOrder}&nbsp;</td>
												<td   align="center" >
													<a class="blue-12"  href="<%=basePath %>system/menu/updateShow.html?id=${cclist.fuid }">修改</a>
													<a onclick="if(!confirm('确定删除！')){return false;}" class="blue-12"
